...
public class adminAgreg extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        InciarSesion.setText("AGREGAR UN USUARIO");
        ...
        btnPrincipalLayout.setHorizontalGroup(
            ...
            .addComponent(txtPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 182, Short.MAX_VALUE)
        );
        btnPrincipalLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, btnPrincipalLayout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(txtPrincipal, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
        );

        jPanel1.add(btnPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 420, -1, -1));
    ...
    private void txtGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtGuardarMouseClicked
       ...
       String contr = inputContr.getText();
       String permisos = (String) cboPermisos.getSelectedItem();
       cont.guardarUsuario(usuario,contr,permisos);
       mostrarMensja("Guardado", "Info", "Mensaje");
       this.dispose();
